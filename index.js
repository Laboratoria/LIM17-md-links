import { determinateAbsolutePath, createAbsolutePath, validatePath, ifIsDirectory, ifIsFile,readaPathDirectory,readaPathFile} from './api.js'
const mdlinks = (route) => {
